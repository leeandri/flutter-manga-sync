...
// in flutter_manga_sync/test/features/manga/data/repositories/manga_repository_impl_test.dart.
...
class MockMangaLocalDataSource extends _i1.Mock
    implements _i10.MangaLocalDataSource {
  ...
  @override
  _i8.Future<void> removeFavorite(String? id) => (super.noSuchMethod(
        Invocation.method(
          #removeFavorite,
          [id],
        ),
